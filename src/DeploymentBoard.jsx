...
//   createDeployment, deleteDeployment, saveRows, PAMember,
// }) {
                                      ...
                                      row.details?.map((d, di) => {
                                        ...
                                        return (
                                          <tr key={d.id} style={{ borderBottom: '1px solid #1e293b' }}>
                                            {di === 0 && (
                                              <td rowSpan={row.details.length} style={{ padding: '6px 8px', color: '#475569',
                                                textAlign: 'center', verticalAlign: 'middle', fontWeight: 700 }}>
                                                {rowIdx + 1}
                                              </td>
                                            )}
                                            {di === 0 && (
                                              <td rowSpan={row.details.length} style={{ padding: '6px 8px', verticalAlign: 'top' }}>
                                                {taskUrl
                                            ...
                                            <td style={{ padding: '6px 8px', color: '#94a3b8' }}>{d.remark || ''}</td>
                                            ...
                                            <td style={{ padding: '6px 8px', color: '#94a3b8', textAlign: 'center' }}>{d.md || '—'}</td>
                                            <td style={{ padding: '6px 8px', color: '#94a3b8', textAlign: 'center' }}>{d.pic || '—'}</td>
                                            <td style={{ padding: '6px 8px', color: '#ef4444', textAlign: 'center', fontWeight: 600 }}>
                                              {d.liveDate || '—'}
                                            </td>
                                          </tr>
                                        )
