...
function AppInner() {
  ...
  async function auditedCreateDeployment(form) {
    ...
    if (res.success) {
      log({
        ...
        target: form.deployDate,
        detail: { environment: form.environment }
      })
    }
  ...
  async function auditedDeleteDeployment(id) {
    ...
    log({
      ...
      target: dep?.deploy_date || String(id)
    })
  }
